...
internal static class LegacyAppNavigation
{
    ...
    [
        ...
        [
            ...
            new("New customer", "/customers/new", Icons.Material.Outlined.PersonAdd, RequiredPermission: "legacy-customer.customers.create", Description: "Onboard a customer", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/customers"),
            ...
            new("New order", "/Orders/Create", Icons.Material.Outlined.AddShoppingCart, RequiredPermission: "legacy.orders.create", Description: "Create an order", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/sales/orders"),
            ...
            new("New quotation", "/Quotations/Create", Icons.Material.Outlined.RequestQuote, RequiredPermission: "legacy.quotations.create", Description: "Create a quotation", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/Quotations/Index"),
        ]),
        ...
        [
            ...
            new("New invoice", "/accounting/new", Icons.Material.Outlined.ReceiptLong, RequiredPermission: "legacy.accounting.create", Description: "Create an invoice", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/finance/invoices"),
            ...
            new("New finance record", "/Finances/Create", Icons.Material.Outlined.AddCard, RequiredPermission: "legacy.accounting.create", Description: "Record a payment", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/Finances/Index"),
        ...
        [
            ...
            new("New material", "/Materials/Create", Icons.Material.Outlined.AddBox, RequiredPermission: "legacy-catalog.materials.create", Description: "Create a material", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/mfg/materials"),
        ]),
        ...
        [
            ...
            new("New purchase order", "/purchasing/new", Icons.Material.Outlined.AddShoppingCart, RequiredPermission: "legacy-procurement.purchase-orders.create", Description: "Create a purchase order", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/purchasing"),
            ...
            new("New supplier", "/Suppliers/Create", Icons.Material.Outlined.AddBusiness, RequiredPermission: "legacy-procurement.suppliers.create", Description: "Create a supplier", Kind: LegacyNavItemKind.ChildAction, ParentHref: "/purchasing/suppliers"),
        ]),
