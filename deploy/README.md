...
- `Legacy.Maliev.AppHost` main commit `137fe398` projects these two Data Protection certificate values into both Intranet hosts for local Aspire testing. Keep this projection aligned with the fail-closed production contract.
