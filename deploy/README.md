...
- `Legacy.Maliev.AppHost` main commit `973a5544cf54dfa3fc8bab509ee8271dd377c950` projects the Intranet-specific Data Protection certificate values into the Intranet BFF for local Aspire validation. Keep this projection aligned with the fail-closed production contract; the Razor Pages compatibility host remains separately gated for cutover.
